...
const ffi = Library(`../${pf}/lib${pf}.so`, {
    'create':           [ uint64, [ ref.refType(InigoConfig) ] ],
    'process_request':  [ uint64, [ uint64, pointer, int, ref.refType(pointer), ref.refType(int) ] ],
    'process_response': [ _void_, [ uint64, uint64, pointer, int, ref.refType(pointer), ref.refType(int) ] ],
...
class Query {
    ...
    processRequest() {
        ...
        this.#handle = ffi.process_request(this.#instance, input, input.length, output_ptr, output_len_ptr);
    ...
    processResponse(data) {
        ...
        ffi.process_response(this.#instance, this.#handle, input, input.length, output_ptr, output_len_ptr);
        const output = ref.readPointer(output_ptr, 0, output_len_ptr.deref());
